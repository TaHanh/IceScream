import 'package:guide_ice_scream/model/Category.dart';
import 'package:guide_ice_scream/model/question.dart';

List<Category> data = [
  Category(name: "Choose A Preferred Playing Mode", image: "assets/images/110.png", description: [
  ...
  Category(name: "Stay Out Of Sight And Be Quiet At All Times", image: "assets/images/120.png", description: [
  ...
  Category(name: "Watch Videos To Receive Hints And Clues", image: "assets/images/130.jpg", description: [
  ...
  Category(name: "Use The Map To Travel From One Location To The Other", image: "assets/images/140.png", description: [
  ...
  Category(name: "First Go To The Cafeteria", image: "assets/images/150.png", description: [
  ...
  Category(name: "Explore The Playground And Find The Guard’s Jacket", image: "assets/images/160.png", description: [
  ...
  Category(name: "Visit The Parking Lot And Unlock The Office Room", image: "assets/images/170.png", description: [
  ...
  Category(name: "Escape From The Stall If You Get Caught", image: "assets/images/180.png", description: [
...
List<Question> questions = [
  Question(question: "What is the use of pliers And where will you use it ?", answer: [
    Answer(user: "Zee khan", value: "The pliers is used for cut the wire and take the cage key to open the cage.")
  ]),
  Question(
    question: "How do u get into the garage with the car in it ?",
    answer: [
      Answer(
          user: "Suptucker",
          value:
              "To get to the car you need to go to the cafe and go thought the trash once you get the code from the trash you go to the cash register and get the coins than you go to the playground and put the coins in the mystery vending machine then you will get a paintball gun which you use to shoot the button through the door to open the garage.")
    ],
  ),
  Question(
    question: "How do you cut the light, in this game ?",
    answer: [
      Answer(
          user: "Cut the loght",
          value: "You get the car break the half wall thing at the parking space and the will be a wire.")
    ],
  ),
  Question(
    question: "Where is the oil found for greasing the gate ?",
    answer: [
      Answer(user: "KittyKat", value: "The oil is in the cafeteria in the room that you need an ID card."),
      Answer(user: "Santuco", value: "I saw it in that room but then it disappeared."),
      Answer(
          user: "Mr WOLF", value: "I have restarted the game 4 times and I cant get the oil can it just won't spawn."),
      Answer(
          user: "Fish head",
          value:
              "1st u find it in the oven drawer. If it's not there then it's on the counter to the right side of the sink in the kitchen at the cafeteria."),
    ],
  ),
  Question(
    question: "How to use map in game ?",
    answer: [
      Answer(
          user: "Beatrix", value: "All the Locations: 1.Neighborhood, 2.Stall, 3.Cafeteria, 4.Parking, 5.Playground"),
      Answer(user: "SunKid", value: "Ice scream 2: 1.Neighborhood, 2.Cinema, 3.Cemetery, 4.Circus, 5.Stall"),
    ],
  ),
];
